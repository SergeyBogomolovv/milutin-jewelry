...
func TestCollectionsUsecase_Create(t *testing.T) {
	...
	usecase := NewCollectionsUsecase(tu.NewTestLogger(), mockFS, mockRepo)
	t.Run("success", func(t *testing.T) {
		...
		id, err := usecase.Create(ctx, &dto.CreateCollectionRequest{Image: tu.NewTestFile("image")})
	...
	t.Run("failed to upload image", func(t *testing.T) {
		...
		_, err := usecase.Create(ctx, &dto.CreateCollectionRequest{Image: tu.NewTestFile("image")})
		assert.Error(t, err)
		mockFS.AssertExpectations(t)
	})
...
func TestCollectionsUsecase_Update(t *testing.T) {
	...
	t.Run("failed to delete image", func(t *testing.T) {
		...
		err := usecase.Update(ctx, &dto.UpdateCollectionRequest{Image: tu.NewTestFile("image")})
...
func TestCollectionsUsecase_GetByID(t *testing.T) {
	...
	usecase := NewCollectionsUsecase(tu.NewTestLogger(), nil, mockRepo)
